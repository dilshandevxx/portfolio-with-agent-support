    ...
    <section className="py-20 px-6 md:px-12" id="contact">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-5 gap-8 bg-[#111] rounded-[2rem] p-4 lg:p-6 overflow-hidden">
          {/* Form */}
           <div className="lg:col-span-2 bg-zinc-900/50 rounded-3xl p-8 flex flex-col gap-6">
              <div>
           ...
           <div className="lg:col-span-3 min-h-[400px] bg-[#1a1a1a] rounded-3xl relative overflow-hidden group">
